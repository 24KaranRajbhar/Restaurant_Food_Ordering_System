Public Class continental
    ...
    Private Sub PictureBox2_Click_1(sender As Object, e As EventArgs) Handles PictureBox2.Click
        orderdetails.Show()
        itemprice = 180
        orderdetails.Label5.Text = "Western Conti Food"
    ...
    Private Sub PictureBox3_Click_1(sender As Object, e As EventArgs) Handles PictureBox3.Click
        orderdetails.Show()
        itemprice = 120
        orderdetails.Label5.Text = "Blueberry Crepes"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox4_Click_1(sender As Object, e As EventArgs) Handles PictureBox4.Click
        orderdetails.Show()
        itemprice = 250
        orderdetails.Label5.Text = "Chicken Kabab"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox5_Click_1(sender As Object, e As EventArgs) Handles PictureBox5.Click
        orderdetails.Show()
        itemprice = 100
        orderdetails.Label5.Text = "Curtesy Belesaru"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox7_Click_1(sender As Object, e As EventArgs) Handles PictureBox7.Click
        orderdetails.Show()
        itemprice = 200
        orderdetails.Label5.Text = "Curtesy Yummy"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox6_Click_1(sender As Object, e As EventArgs) Handles PictureBox6.Click
        orderdetails.Show()
        itemprice = 100
        orderdetails.Label5.Text = "Cherry Noodles"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox11_Click_1(sender As Object, e As EventArgs) Handles PictureBox11.Click
        orderdetails.Show()
        itemprice = 150
        orderdetails.Label5.Text = "Noodo Prawns"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox10_Click_1(sender As Object, e As EventArgs) Handles PictureBox10.Click
        orderdetails.Show()
        itemprice = 250
        orderdetails.Label5.Text = "Contispicy Food"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox9_Click_1(sender As Object, e As EventArgs) Handles PictureBox9.Click
        orderdetails.Show()
        itemprice = 125
        orderdetails.Label5.Text = "Onio Masala"
        orderdetails.Label7.Text = itemprice
    End Sub
    ...
    Private Sub PictureBox8_Click_1(sender As Object, e As EventArgs) Handles PictureBox8.Click
        orderdetails.Show()
        itemprice = 90
        orderdetails.Label5.Text = "Rosted Pieces"
        orderdetails.Label7.Text = itemprice
    End Sub
End Class